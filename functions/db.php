...
try {
    ...
    // Create subnet_tags junction table for Many-to-Many relationship between subnets and tags
    ...
    // Migration: Copy existing subnets.tag_id into subnet_tags if not already present
